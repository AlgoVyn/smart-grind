...
**Winner**: Bidirectional when both endpoints known (2x-1000x faster)
...
| **Standard BFS** | O(V + E) | O(V) | Unweighted shortest path |
...
|-----------|---------------|----- |
| Word ladder | Bidirectional BFS | Known start/end words |
...
| Unweighted grid | Bidirectional BFS | Meeting in middle helps |
