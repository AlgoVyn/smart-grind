            ...
            <div class="flex flex-col sm:flex-row justify-between gap-4">
                ...
                <div class="flex items-center gap-2 shrink-0">
                    ...
                    <div class="flex items-center bg-dark-900 rounded-lg border border-slate-800">
                        <button class="action-btn p-2 rounded-l-lg hover:bg-dark-800 text-theme-base hover:text-green-500 transition-colors border-r border-slate-800" data-action="ask-chatgpt" title="Ask ChatGPT (Copies prompt & opens)">
                        ...
                        <button class="action-btn p-2 hover:bg-dark-800 text-theme-muted hover:text-blue-400 transition-colors border-r border-slate-800" data-action="ask-gemini" title="Ask Gemini (Copies prompt & opens)">
                            <svg class="w-4 h-4 transition-colors" viewBox="0 0 24 24" fill="currentColor">
