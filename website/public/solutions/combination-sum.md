...
Time complexity: Exponential, but constrained by small inputs (candidates <= 30, target <= 40, <150 combinations). Space complexity: O(target) for the recursion stack and path.
