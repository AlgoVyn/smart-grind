...
Time complexity: O(m + n), where m and n are the lengths of the valid parts of nums1 and nums2, as each element is processed once.
Space complexity: O(1), since the merge is done in place within nums1.
