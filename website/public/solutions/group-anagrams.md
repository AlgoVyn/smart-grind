...
Anagrams have the same characters in different order, so sorting each string gives a unique key.

Use a defaultdict to group strings by their sorted version.
