...
Time Complexity: O(n), where n is the length of the array, as we may traverse the entire array and insert up to log(k) digits.

Space Complexity: O(log k) in the worst case for inserting new digits at the front.
