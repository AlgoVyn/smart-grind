...
Time Complexity: O(n^2), where n is the length of the array, due to the nested loops (one for i, one for the two pointers).

Space Complexity: O(1) additional space, excluding the input array, since we sort in place.
