...
## Problem Description
[Link to problem](https://leetcode.com/problems/partition-equal-subset-sum/)
...
Time complexity: O(n * sum), where n is array length and sum is total sum. Space complexity: O(sum).
