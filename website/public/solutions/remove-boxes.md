...
## Problem Description
[Link to problem](https://leetcode.com/problems/remove-boxes/)
...
Use recursive DP with memoization. dp(l, r, k) is the max points for subarray l to r with k additional boxes of the same color as boxes[r] after r.
...
- O(n^3), due to three nested loops/recursions.

### Space Complexity

- O(n^3), for the memo dictionary.
