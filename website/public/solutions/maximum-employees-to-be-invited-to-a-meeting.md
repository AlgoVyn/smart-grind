...
## Problem Description
[Link to problem](https://leetcode.com/problems/maximum-employees-to-be-invited-to-a-meeting/)
...
The maximum is the max of the cycle sizes and the cycle sizes plus attached chains.
