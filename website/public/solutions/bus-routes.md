...
Time Complexity: O(n * m + b^2), where n is the number of stops, m is the average route length, and b is the number of buses, due to graph construction and BFS.

Space Complexity: O(n + b^2), for the mappings and graph.
