...
Time complexity: O(n), where n is the length of the string, as we process each character once. Space complexity: O(n) in the worst case due to the stack for deeply nested parentheses.
