...
Time complexity is O(N + E), where N is the number of nodes and E is the number of edges, as each node and edge is visited at most once. Space complexity is O(N) for the graph, visited array, and recursion stack.
