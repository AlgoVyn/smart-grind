...
## Problem Description
[Link to problem](https://leetcode.com/problems/maximum-width-ramp/)
...
Sort indices by nums value ascending. Iterate through sorted indices, maintaining the minimum index seen so far, and compute the width for each as current index minus min_index.

### Step-by-Step Explanation

1. **Sort Indices**: By nums value.
