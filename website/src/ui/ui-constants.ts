// --- UI CONSTANTS ---
// Shared constants and HTML templates

// Shared Google button HTML template
export const GOOGLE_BUTTON_HTML = `
...
export const SPINNER_HTML = (size = 'h-4 w-4', color = 'text-current') => `
    <div class="flex items-center justify-center">
        <svg aria-hidden="true" class="animate-spin ${size} ${color}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
// AI buttons HTML template
export const AI_BUTTONS_HTML = `
    <div class="flex items-center bg-dark-900 rounded-lg border border-slate-800">
        <button class="action-btn p-2 rounded-l-lg hover:bg-dark-800 text-theme-base hover:text-green-500 transition-colors border-r border-slate-800" data-action="ask-chatgpt" title="Ask ChatGPT (Pre-loads query & opens)">
            <svg aria-hidden="true" fill="currentColor" class="w-4 h-4 transition-colors" viewBox="0 0 24 24">
        ...
        <button class="action-btn p-2 rounded-r-lg hover:bg-dark-800 text-theme-muted hover:text-theme-bold transition-colors border-l border-slate-800" data-action="ask-grok" title="Ask Grok (Pre-loads query & opens)">
            <svg aria-hidden="true" fill="currentColor" fill-rule="evenodd" class="w-4 h-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9.27 15.29l7.978-5.897c.391-.29.95-.177 1.137.272.98 2.369.542 5.215-1.41 7.169-1.951 1.954-4.667 2.382-7.149 1.406l-2.711 1.257c3.889 2.661 8.611 2.003 11.562-.953 2.341-2.344 3.066-5.539 2.388-8.42l.006.007c-.983-4.232.242-5.924 2.75-9.383.06-.082.12-.164.179-.248l-3.301 3.305v-.01L9.267 15.292M7.623 16.723c-2.792-2.67-2.31-6.801.071-9.184 1.761-1.763 4.647-2.483 7.166-1.425l2.705-1.25a7.808 7.808 0 00-1.829-1A8.975 8.975 0 005.984 5.83c-2.533 2.536-3.33 6.436-1.962 9.764 1.022 2.487-.653 4.246-2.34 6.022-.599.63-1.199 1.259-1.682 1.925l7.62-6.815"></path></svg>
        </button>
    </div>
`;

// Solution button HTML template
export const SOLUTION_BUTTON_HTML = `
...
// Pattern solution button HTML template
export const PATTERN_SOLUTION_BUTTON_HTML = (patternName: string) => `
    <button class="action-btn p-2 rounded-lg bg-dark-900 text-theme-muted hover:text-blue-400 transition-colors inline-flex items-center justify-center" data-action="pattern-solution" data-pattern="${patternName}" title="View Pattern Solution">
        <svg aria-hidden="true" fill="currentColor" class="w-4 h-4" viewBox="0 0 24 24">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
            <polyline points="14,2 14,8 20,8"/>
            <line x1="16" y1="13" x2="8" y2="13"/>
