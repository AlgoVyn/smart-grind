...
export const patterns = {
    ...
    async checkPatternSolutionExists(patternName: string) {
        ...
        const solutionFile = `${import.meta.env['BASE_URL']}patterns/${filename}.md`;
...
export const openSolutionModal = (problemId: string) => {
    const solutionFile = `${import.meta.env['BASE_URL']}solutions/${problemId}.md`;
...
export const openPatternSolutionModal = (patternName: string) => {
    ...
    const solutionFile = `${import.meta.env['BASE_URL']}patterns/${patternFilename}.md`;
    _loadSolution(
        solutionFile,
