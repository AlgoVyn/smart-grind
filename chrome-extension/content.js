(async () => {
  ...
  const generateAIButtons = () => `
    <div class="flex items-center bg-fill-tertiary dark:bg-fill-tertiary rounded-lg border border-gray-600">
      <button class="p-2 rounded-l-lg hover:bg-fill-quaternary dark:hover:bg-fill-quaternary text-gray-60 dark:text-gray-60 hover:text-lc-icon-primary dark:hover:text-dark-lc-icon-primary transition-colors border-r border-gray-600" data-action="ask-chatgpt" title="Ask ChatGPT">
